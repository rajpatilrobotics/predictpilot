...
const routeSpecs = [
  ...
  'demo|/demo|Demo|Offline Demo|Demo|Judge walkthrough and proof checkpoints|Honest offline demo walkthrough for judges when wallet funding or live proof is unavailable.|Demo flow|Walk through the intended proof story without fake wallet signatures or fabricated digests.',
  'judge-demo|/judge-demo|Demo|Live Demo Guide|Guide|Guided live proof runway|Guided judge runway from wallet readiness to best market, strategy review, digest, reconciliation, and Proof Center.|Judge path|Follow the next safe live step without using fixtures as proof.',
  'proof|/proof|Demo|Proof Center|Proof|Judge-verifiable execution proof|Source-labeled proof cockpit for wallet readiness, chain digest evidence, indexed reconciliation, and local session context.|Proof center|Verify wallet, chain digest, indexed refresh, and proof readiness without fake transaction evidence.',
] as const;
